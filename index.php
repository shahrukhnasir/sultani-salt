                        ...
                        <div class="row sp-row row-cols-lg-2 row-cols-md-2 row-cols-sm-2 row-cols-2">
                            <div class="collection-item sp-col">
                                <a href="/" class="zoom-scal clr-none">
                                    ...
                                    <div class="details bottom-center p-lg-0">
                                        <div class="inner">
                                            <span class="btn btn-primary btn-lg text-nowrap">SHACKER JAR/span>
                                        </div>
                                    </div>
                                </a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="tabs-listing">
                ...
                <div class="tab-content" id="productTabsContent">
                    <div class="tab-pane show active" id="sunglasses" role="tabpanel" aria-labelledby="sunglasses-tab">
                        <!--Product Grid-->
                        <div class="grid-products grid-view-items pro-hover4">
                            <div class="row col-row row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">
                    ...
                    <div class="tab-pane" id="readingGlasses" role="tabpanel" aria-labelledby="readingGlasses-tab">
                        <!--Product Grid-->
                        <div class="grid-products grid-view-items pro-hover4">
                            <div class="row col-row row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">
                                <div class="item col-item">
                    ...
                    <div class="tab-pane" id="premiumEyeglasses" role="tabpanel" aria-labelledby="premiumEyeglasses-tab">
                        <!--Product Grid-->
                        <div class="grid-products grid-view-items pro-hover4">
                            <div class="row col-row row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">
                                <div class="item col-item">
                ...
                <div class="row">
                        ...
                        <div id="quickView" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="item carousel-item active" data-bs-slide-number="0">
                                    <img class="blur-up lazyload" data-src="assets/images/products/sunglasses-product1.jpg" src="assets/images/products/sunglasses-product1.jpg" alt="product" title="Product" width="500" height="500" />
                                </div>
                                <div class="item carousel-item" data-bs-slide-number="1">
                                    <img class="blur-up lazyload" data-src="assets/images/products/sunglasses-product2.jpg" src="assets/images/products/sunglasses-product2.jpg" alt="product" title="Product" width="500" height="500" />
                                </div>
                                <div class="item carousel-item" data-bs-slide-number="2">
                                    <img class="blur-up lazyload" data-src="assets/images/products/sunglasses-product3.jpg" src="assets/images/products/sunglasses-product3.jpg" alt="product" title="Product" width="500" height="500" />
                                </div>
                                <div class="item carousel-item" data-bs-slide-number="3">
                                    <img class="blur-up lazyload" data-src="assets/images/products/sunglasses-product4.jpg" src="assets/images/products/sunglasses-product4.jpg" alt="product" title="Product" width="500" height="500" />
                                </div>
                                <div class="item carousel-item" data-bs-slide-number="4">
                                    <img class="blur-up lazyload" data-src="assets/images/products/sunglasses-product5.jpg" src="assets/images/products/sunglasses-product5.jpg" alt="product" title="Product" width="500" height="500" />
                                </div>
                                <div class="item carousel-item" data-bs-slide-number="5">
                                    <img class="blur-up lazyload" data-src="assets/images/products/sunglasses-product6.jpg" src="assets/images/products/sunglasses-product6.jpg" alt="product" title="Product" width="500" height="500" />
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="product-info">
                            <p class="product-vendor">Vendor:<span class="text"><a href="#">Sunglasses</a></span></p>
                            <p class="product-type">Product Type:<span class="text">Gentle</span></p>
                        ...
                        <div class="pro-stockLbl my-2">
                            ...
                            <span class="d-flex-center stockLbl lowstock" data-qty="15"><i class="icon anm anm-exclamation-cir text-primary"></i><span> Order now, Only <span class="items">10</span> left!</span></span>
                        </div>
                            ...
                            <div class="product-options d-flex-wrap">
                                ...
                                <div class="product-action d-flex-wrap w-100 pt-1 mb-3 clearfix">
                                    ...
                                    <div class="addtocart ms-3 fl-1">
                                        <button type="submit" name="add" class="btn btn-primary product-cart-submit w-100"><i class="icon anm anm-bag-l me-2"></i><span>Add to cart</span></button>
...
<!--About Video Modal-->
<div class="featuredVideo-modal modal fade" id="featuredVideo_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
...
<script>
    ...
    $(".home-page .header-bg").removeClass("body-bg");
</script>