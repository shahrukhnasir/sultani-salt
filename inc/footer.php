...
<style>
    ...
    #newsLatter_btn .btn-light .btn {
        font-size: 16px;
        text-transform: uppercase;
        font-family: var(--primary-extra-bold);
    }

    #newsLatter_btn .btn-light {
        cursor: pointer;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-3 footer-contact mt-1 mt-md-4 mt-lg-0">
                    ...
                    <p class="address d-flex"><i class="icon anm anm-map-marker-al pt-1"></i> 123 Street Name, City, England</p>
